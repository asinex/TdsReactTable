...
class MyReactTable extends Component {
  ...
  render() {
    ...
    // console.log(JSON.stringify(colsArray)+"--updated columns are :"+JSON.stringify(updatedColumns))
    ...
    return (
      ...
      <StyledContainer>
      <div>
        <button onClick={this.togglePopup.bind(this)}>Columns</button>
        {this.state.showPopup ? 
          <Popup
            text='Columns'
            columns={colsArray}
            closePopup={this.togglePopup.bind(this)}
            showHideColumns={this.toggleColumns.bind(this)}
          />
          : null
        }
        </div>
        ...
        {/* <div>
        <button onClick={this.togglePopup1.bind(this)}>Columns1</button>
        {this.state.showPopup1 ? 
           <ColumnToggler columns={this.state.checkboxes}/>
          : null
        }
        </div> */}
